...
from user.models import z_users
...
class zpraba_conn(models.Model):
    ...
    created_by = models.ForeignKey(z_users, related_name='%(class)s_created', on_delete=models.CASCADE)
    created_date = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    last_modified_by = models.ForeignKey(z_users, related_name='%(class)s_last_modified', on_delete=models.CASCADE)
    ...
    modified_by = models.ForeignKey(z_users, related_name='%(class)s_modified', on_delete=models.CASCADE)
